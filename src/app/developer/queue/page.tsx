            ...
            <div className="flex items-center gap-3">
              {profile.role === "admin" && (
                <Link
                  ...
                  className="rounded-xl border border-white/10 px-4 py-2.5 text-sm text-slate-300 hover:bg-white/5 hover:text-white"
                >
                  Admin Dashboard
                </Link>
              )}
              ...
              {filteredQueue.length === 0 ? (
                ...
                <div className="grid gap-5 xl:grid-cols-2">
                  {filteredQueue.map((item) => {
                    const safeEmail = maskEmail(item.client_email);
                    const safePhone = maskPhone(item.client_phone);
                        ...
                        <div className="flex items-start justify-between gap-4">
                          <div>
                            ...
                            <p className="mt-1 text-sm text-slate-300">
                              {item.business_name || item.project_name}
                            </p>
